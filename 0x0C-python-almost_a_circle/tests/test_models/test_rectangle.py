...
class TestRectangle(unittest.TestCase):
    ...
    def test_116_str(self):
        ...
        self.assertEqual(Rectangle.__str__
                         (self.rectangle1), "[Rectangle] (10) 0/0 - 4/8")
        self.assertEqual(Rectangle.__str__
                         (self.rectangle2), "[Rectangle] (11) 0/0 - 10/10")
        self.assertEqual(Rectangle.__str__
                         (self.rectangle3), "[Rectangle] (12) 2/0 - 3/4")
        self.assertEqual(Rectangle.__str__
                         (self.rectangle4), "[Rectangle] (98) 1/2 - 8/11")
        self.assertEqual(Rectangle.__str__
                         (self.rectangle5), "[Rectangle] (13) 4/5 - 3/8")

    def test_117_display(self):
        """Testing display"""
        f = io.StringIO()
        with contextlib.redirect_stdout(f):
            self.rectangle7.display()
        s = f.getvalue()
        self.assertEqual(s, "\n ##\n ##\n ##\n")
    ...
    def test_125_update_kwargs_1(self):
        """Testing upd **kwargs"""
        with self.assertRaises(TypeError):
            self.rectangle5.update(1, "ray", 1, 1, 1, width=5)
        with self.assertRaises(TypeError):
